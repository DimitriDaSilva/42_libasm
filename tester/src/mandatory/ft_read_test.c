...
/*   Updated: 2021/03/27 18:30:34 by dda-silv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_read_test(void)
{
	...
	check(test(1, buf, CHARS_READ, EXIT_SUCCESS)); bzero(buf, CHARS_READ);
	check(test(5, buf, CHARS_READ, EBADF)); bzero(buf, CHARS_READ);
	check(test(-1, buf, CHARS_READ, EBADF)); bzero(buf, CHARS_READ);
